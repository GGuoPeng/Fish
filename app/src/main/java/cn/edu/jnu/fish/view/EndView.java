...
import cn.edu.jnu.fish.myfish.MainActivity;
...
public class EndView extends BaseView{
	...
	public void initBitmap() {
		...
		background = BitmapFactory.decodeResource(getResources(), R.drawable.bg_ready);
		button = BitmapFactory.decodeResource(getResources(), R.drawable.button_on);
		button2 = BitmapFactory.decodeResource(getResources(),R.drawable.button_off);
